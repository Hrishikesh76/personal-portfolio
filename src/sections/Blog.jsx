        ...
        {blogPosts.map((post, index) => (
          <motion.article key={post.title} className="glass overflow-hidden rounded-3xl transition hover:-translate-y-1" variants={fadeInUp}>
            ...
            <div className="p-6">
              ...
              <Link to="/blog" className="focus-ring mt-5 inline-flex items-center gap-2 rounded-full text-sm font-bold text-brand-700 hover:text-brand-500 dark:text-accent-400">
